<div class="box">
    ...
    <div id="collapse2" class="body collapse in">
        ...
        <form name="basic-form" id="basic-form" action="" method="post" enctype="multipart/form-data" novalidate>
            ...
            if (isset($valorForm['id'])): echo $valorForm['id'];
            endif;
            ?>">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <button type="button" id='refresh' class="btn btn-primary btn-block" onclick="enviarDados('<?php echo URL; ?>controle-artigo/editar/<?= $valorForm['id'] ?>', 'basic-form')" value="REGISTAR" name="basic-form">SALVAR</button>
                </div>
            </div>
        </form>
    </div>
