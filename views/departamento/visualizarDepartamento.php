<div class="box">
    <header class="dark" style="">
        ...
        <div class="toolbar">
            <ul class="nav">
                <li>
                    <div class="btn-group">
                        <a class="accordion-toggle btn btn-xs minimize-box" onclick="enviaDados('<?=URL.'controle-departamento/index'?>',null,'content')"
    ...
    <div id="collapse2" class="body collapse in">
        ...
        if (!empty($this->Dados[0]['id'])):
            ?>
            <h4 class="heading">Detalhes do Laboratório</h4>
            <dl class="row">
