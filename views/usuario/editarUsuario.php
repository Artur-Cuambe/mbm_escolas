...
//var_dump($valorForm);
        ...
        <form name="basic-form" id="basic-form"  class="form-horizontal" action="" method="post" enctype="multipart/form-data" novalidate>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-4">
                    <button type="button" id='refresh' class="btn btn-primary btn-block" onclick="enviarDadosFile('<?php echo URL; ?>controle-usuario/editar/<?php echo $valorForm['id']; ?>')" value="SALVAR" name="basic-form">SALVAR</button>
                </div>
            </div>
        </form>
