    ...
    <div id="collapse2" class="body collapse in">
        ...
        <form  name="basic-form" id="basic-form" class="form-horizontal"  method="post" enctype="multipart/form-data" >
            ...
            <div style="text-align:center" class="form-actions no-margin-bottom">
                <input type="button" value="Salvar" class="btn btn-success btn-grad" onclick="enviarDados('<?php echo URL; ?>controle-niveis-acesso/editar/<?php echo $valorForm['id']; ?>', 'basic-form')"  value="SALVAR" name="basic-form"/>
            </div>
        </form>
    </div>
</div>
